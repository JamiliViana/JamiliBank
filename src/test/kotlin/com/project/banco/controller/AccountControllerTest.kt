...
//            .param("cpf",account!!.cpf))
//            ?.andExpect(MockMvcResultMatchers.status().isOk)
//
//        var buscaConta = service?.getByCpf(account!!.cpf!!)
//        Assertions.assertEquals(account,buscaConta)
//    }
//    @Test
...
//        service.createAccount(Account("123.456.789-10",0.0))
...
//        val cpf = "123.456.789-10"
//        service.createAccount(Account(cpf,100.0))
//        val transacaoRequest = TransacaoRequest(valor = 10.0)
//
...
//        service.createAccount(Account(cpf,0.0))
//        val transacaoRequest = TransacaoRequest(valor = 10.0)
//
//        mockMvc.perform(put("/banco/saque/{cpf}", cpf)
//            .contentType(MediaType.APPLICATION_JSON)
...
//        val cpf = "123.456.789-0"
//        service.createAccount(Account(cpf,110.0))
//        val transacaoRequest = TransacaoRequest(valor = -10.0)
//
//        mockMvc.perform(put("/banco/saque/{cpf}", cpf)
//            .contentType(MediaType.APPLICATION_JSON)
...
//        service.createAccount(Account(cpfOrigem,100.0))
//        service.createAccount(Account(cpfDestino,0.0))
...
//        val cpfOrigem = "123.456.789-10"
//        val cpfDestino = "987.654.321-01"
//        service.createAccount(Account(cpfOrigem,10.0))
//        service.createAccount(Account(cpfDestino,0.0))
//        val transacaoRequest = TransacaoRequest(valor = 50.0)
//
//        mockMvc.perform(put("/banco/transferencia/{cpfOrigem}/{cpfDestino}", cpfOrigem, cpfDestino)
